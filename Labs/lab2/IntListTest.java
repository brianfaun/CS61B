...
public class IntListTest {
    ...
    public void testSquareListRecursive() {
        ...
        assertEquals(IntList.list(1,4,9), IntList.squareListRecursive(IntList.list(1,2,3)));

        // TODO: test for non-destructiveness
        IntList tester = IntList.list(1, 2, 3);
        IntList.squareListRecursive(tester);
        assertEquals(tester, IntList.list(1,2,3));
